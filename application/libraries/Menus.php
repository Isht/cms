...
//                $output .= $this->t_item_close;
        ...
        $ext = '<ul class="nav navbar-nav navbar-right">';
        $ext .= '<li class="btn btn-xs btn-warning btn-custom">';
        $ext .= '<a href="' . base_url('member/') . '"><i class="fa fa-lock"></i>&nbsp;&nbsp;My Account</a>';
        $ext .= '</li></ul>';

        return $output . $this->t_tag_close . $ext . $this->t_menu_close . PHP_EOL;
    }
